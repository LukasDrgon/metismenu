...
1. Include metismenu StyleSheet
  ...
  ```html
  <link rel="stylesheet" href="//cdn.jsdelivr.net/jquery.metismenu/2.7.1/metisMenu.min.css">
  ```
...
3. Include metisMenu plugin's code
  ...
  ```
      OR
  ```html
  <script src="//cdn.jsdelivr.net/jquery.metismenu/2.7.1/metisMenu.min.js"></script>
  ```
...
| **Commits** | **Contributor** |  
| --- | --- |  
| 115 | [onokumus](https://github.com/onokumus) |  
...
_This file was generated by [verb-generate-readme](https://github.com/verbose/verb-generate-readme), v0.5.0, on May 11, 2017._
